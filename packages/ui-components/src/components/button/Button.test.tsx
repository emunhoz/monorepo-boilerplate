...
describe('[Component]: Button', () => {
  ...
  test('render ghost style', () => {
    const { asFragment } = render(
      <Button ghost onClick={mockOnClickFunction}>
        Hello world
      </Button>
    )
  ...
  test('render component with small size style', () => {
    const { asFragment } = render(
      <Button size="small" onClick={mockOnClickFunction}>
        Hello world
      </Button>
    )
  ...
  test('render component with big size style', () => {
    const { asFragment } = render(
      <Button size="big" onClick={mockOnClickFunction}>
        Hello world
      </Button>
    )
  ...
  test('render component disabled', () => {
    const { asFragment } = render(
      <Button disabled onClick={mockOnClickFunction}>
        Hello world
      </Button>
    )
